...
class TypedefException(BlackboxProtobufException):
    ...
    def __str__(self):
        ...
        if self.path is not None:
            message = ("Encountered error within typdef for field %s: " % "->".join(map(str, self.path))) + message
        return message
...
class EncoderException(BlackboxProtobufException, ValueError):
    ...
    def __str__(self):
        ...
        if self.path is not None:
            message =  ("Encountered error encoding field %s: " % "->".join(map(str, self.path))) + message
        return message
...
class DecoderException(BlackboxProtobufException, ValueError):
    ...
    def __str__(self):
        ...
        if self.path is not None:
            message =  ("Encountered error decoding field %s: " % "->".join(map(str, self.path))) + message
        return message
